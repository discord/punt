...
messages = [
        '393 <133>Mar 14 04:20:29 discord-voice-prd-us-central1 audit type=SYSCALL msg=audit(1489465219.995:1699): arch=c000003e syscall=42 success=no exit=-2 a0=6 a1=7ffcf6c928a0 a2=6e a3=7ffcf6c92af0',
